   ...
   function MixGallery(container, elements) {
      ...
      function _addPrevControlAction(prevBtn) {
         prevBtn.addEventListener('click', (e) => {
            ...
            if (_currOverlayElementIndex === -1) {
               _currOverlayElementIndex = _filteredOverlayElements.length - 1
            }
      ...
      function _addNextControlAction(nextBtn) {
         nextBtn.addEventListener('click', (e) => {
            _currOverlayElementIndex += 1
            if (_currOverlayElementIndex === _filteredOverlayElements.length) {
      ...
      function _createElements(elements) {
         elements.forEach((el) => {
            ...
            galleryItem.classList.add('gallery-item', `priority-${el.priority}`)
      ...
      function _applyFilter(btn, elType, navMenu) {
         btn.addEventListener('click', (e) => {
            ...
            const filteredOverlayElements = _allOverlayElements.filter((el) => {
               return el.firstChild.firstChild.tagName === elType
            })
      ...
      function _destroyAllElements() {
         const toRemove =
            _mixGalContainer.getElementsByClassName('elements-container')[0]
